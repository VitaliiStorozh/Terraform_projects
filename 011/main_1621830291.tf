...
//resource "aws_s3_bucket" "phabricator_php" {
//  bucket = var.name
//  acl    = "private"
//
//  tags = {
...
//resource "aws_elastic_beanstalk_application_version" "phabricator_php" {
//  name        = var.solution_stack_name
//  application = "tf-test-name"
//  description = "application version created by terraform"
//  bucket      = aws_s3_bucket.phabricator_php.id
//  key         = aws_s3_bucket_object.phabricator_php.id
//}
